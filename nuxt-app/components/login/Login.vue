...
<style scoped>
  ...
  .selector-container input ~ label, .selector-container a h4 {
    color: var(--theme-inactive);
    transition: color .2s;
  }
  .selector-container input:checked ~ label, .selector-container input:hover ~ label
    , .selector-container a:hover h4 {
